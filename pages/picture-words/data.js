// 看图想韩语 —— 本地兜底内容源
// 结构与 OSS 远程 catalog JSON 保持一致，方便直接生成可上传的 JSON。
...
const PICTURE_WORD_GROUPS = PICTURE_WORD_CATALOG.groups;
const DEFAULT_PICTURE_WORD_GROUP =
  PICTURE_WORD_GROUPS.find((group) => group.id === PICTURE_WORD_CATALOG.defaultGroupId) ||
  PICTURE_WORD_GROUPS[0] ||
  { items: [] };
const PICTURE_WORDS = DEFAULT_PICTURE_WORD_GROUP.items;

module.exports = { PICTURE_WORD_CATALOG, PICTURE_WORD_GROUPS, PICTURE_WORDS };
